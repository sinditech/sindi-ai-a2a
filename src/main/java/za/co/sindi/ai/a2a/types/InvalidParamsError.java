 ...
 */
public final class InvalidParamsError extends JSONRPCError implements A2AError {
	 ...
	 */
	 @JsonbCreator
	public InvalidParamsError(@JsonbProperty int code, @JsonbProperty String message, @JsonbProperty Map<String, Object> data) {
