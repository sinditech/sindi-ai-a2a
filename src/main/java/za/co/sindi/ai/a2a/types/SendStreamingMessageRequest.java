...
public final class SendStreamingMessageRequest extends JSONRPCRequest<MessageSendParams> implements A2ARequest {
	 ...
	 */
	@JsonbCreator
	public SendStreamingMessageRequest(@JsonbProperty JSONRPCVersion jsonrpc, @JsonbProperty RequestId id, @JsonbProperty String method, @JsonbProperty MessageSendParams params) {
